...
<nav class="navbar navbar-expand-lg" style ="background-color :#94A9B2;color:#FFF;"">
  <div class="container-fluid">
	...
	<table border="4"class="table bordered">
		...
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"select * from paket ORDER BY id_paket ASC");
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td>
					<a href="edit2.php?id_paket=<?php echo $d['id_paket']; ?>">EDIT</a>
					<a href="hapus2.php?id_paket=<?php echo $d['id_paket']; ?>" onclick="return confirm('Yakin akan menghapus data ini?')">HAPUS</a>
				</td>
</tr>
<?php
		}
